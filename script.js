...
for (let oneCity of cities) {
    ...
    option.setAttribute('value', oneCity); // za pretragu je bitan ovaj cist podatak unutar 'value'
    ...
    if (oneCity === 'Svi') {
        cityCount = realEstates.length // ukupno nekretnina po svim gradovima zajedno
    }

    option.textContent += ' (' + cityCount + ')'; // dodaje ukupan broj nekretnina po gradu
